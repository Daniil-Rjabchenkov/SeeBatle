...
g.drawLine(leftIndent, topIndent + i * cellSize, leftIndent + fieldSize * cellSize, topIndent + i * cellSize );
g.drawLine(leftIndent + i * cellSize, topIndent, leftIndent + i * cellSize, topIndent + fieldSize * cellSize);
}
